 ...
 */
package View;
import sistemadministrasikeuangan.User;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        User.setFont(new java.awt.Font("Berlin Sans FB Demi", 0, 14)); // NOI18N
    ...
    if (user.equals("thareqarsyad") && pwd.equals("hermudtad"))
    {new Formpebelian().setVisible(true);}
    else {
    JOptionPane.showMessageDialog(null,"Username atau Password salah","TITLE",JOptionPane.WARNING_MESSAGE);
    }
